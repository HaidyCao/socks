...
for abi in "armeabi-v7a" "arm64-v8a" "x86" "x86_64"; do
    ...
    cp -v *.so ${_PREFIX_DIR}/${abi}/

    cd ..
done

# ./cmake_android.sh /Users/haidy/Library/Android/sdk/cmake/3.10.2.4988404/bin/cmake /Users/haidy/Library/Android/sdk/ndk-bundle /Users/haidy/StudioProjects/Network/app/src/main/jniLibs
